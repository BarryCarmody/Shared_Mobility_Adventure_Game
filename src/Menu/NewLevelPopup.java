...
public class NewLevelPopup extends PopupScreen {

    private Level nextLevel;

    public NewLevelPopup(final Dimension size, final Level nextLevel) {
        super(size);
        this.setupInternal(nextLevel);
    }

    public NewLevelPopup(final Level nextLevel) {
        this(new Dimension(400, 200), nextLevel);
    }

    private void setupInternal(final Level nextLevel) {
    ...
    protected void addElements() {
        try {
            ...
            // Button
            final JButton nextLevelButton = new CustomButton("Start Level");
